...
then
  ...
  sshpass -p PASSWORD_HPC scp -P 2222 $BAR USER_HPC@IPADDRESS_HPC:/data/geco_proj_dir/raw/RITM/

  # Saves the sequencing summary file in a variable
  seqsum_file=$(sshpass -p PASSWORD_HPC ssh -p 2222 -T USER_HPC@IPADDRESS_HPC "ls -1 /data/geco_proj_dir/raw/RITM/$DIR/sequencing_summary_*txt")
